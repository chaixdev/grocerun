---
description: Run the minimum Grocerun Definition of Done closeout gate for the current change.
---

Load the `grocerun-minimum-dod`, `grocerun-documentation-extraction`,
`grocerun-test-impact`, `grocerun-architecture-alignment`,
...
1. Inspect current branch changes and planning/review context.
