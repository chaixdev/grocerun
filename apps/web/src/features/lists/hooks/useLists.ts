...
export function useCreateList() {
  return useMutation({
    ...
    onSuccess: async (list) => {
      ...
      // extra fields (deleted, deletedAt, createdAt). The sync endpoint
      // (listToSyncDoc) performs this same transformation for replication —
      // we mirror it here for direct REST mutations.
