...
```
BEFORE (Phase 2):
Component → Server Action → apiClient → NestJS

AFTER (Phase 3):
Component → useQuery/useMutation → apiClient → NestJS
```
...
**Session Context:** Phase 2 complete — all Prisma removed from web actions/pages layer
